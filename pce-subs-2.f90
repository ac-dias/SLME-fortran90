...
subroutine slme(ndim,trial,bbpflux,sepflux,absc,isolar,pin,fr,pm,jsc1,j01,j1,j2,vmax,voc,ff,pce)
...
subroutine sq(ndim,bbpflux,sepflux,iabscoef,isolar,pin,fr,pm,jsc1,j01,j1,j2,vmax,voc,ff,pce)

...
subroutine slme(ndim,trial,bbpflux,sepflux,absc,isolar,pin,fr,pm,jsc1,j01,j1,j2,voc,v2,pce)
	...
	double precision :: voc, aux1,trial,v2

	double precision,dimension(1) :: x0,x
	double precision :: fx
	double precision,external :: negpower
...
subroutine sq(ndim,bbpflux,sepflux,iabscoef,isolar,pin,fr,pm,jsc1,j01,j1,j2,voc,v2,pce)
...
subroutine blackbody(ndim,isolarm,bbir,bbpflux)
...
subroutine interp1D(ndim,vec,x,res)
